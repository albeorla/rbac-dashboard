    ...
    <DashboardLayout>
      <Box layerStyle="pageContainer">
        <Stack spacing={8}>
          {/* Welcome Section */}
          <Box>
            <Heading size="lg" mb={2}>Welcome to RBAC Dashboard</Heading>
            <Text color="text.secondary">
              Manage your users, roles, and permissions from one central location.
            </Text>
          </Box>
            ...
            <Card>
              <CardBody>
                <Stat>
                  ...
                  <StatHelpText>
                    {((activeUsers.length / users.length) * 100).toFixed(1)}% of total
                  </StatHelpText>
                </Stat>
              </CardBody>
            </Card>
